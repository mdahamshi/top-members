...
INSERT INTO messages (user_id,title, content, created_at, pinned) VALUES
(1,'Test', 'Welcome to saramsg, everyone!', NOW() - INTERVAL '2 days', TRUE),
(1,'Test', 'exposed via cloudflare tunnel ! self hosted on my personal server, proxmox, coolify', NOW() - INTERVAL '2 days', TRUE),
(3,'Test', 'Hi, I love Dad.', NOW() - INTERVAL '1 day', TRUE),
(2,'Test', 'This is Amenah and I love Dad.', NOW() - INTERVAL '20 hours', TRUE),
(4,'Test', 'Salmah here, excited to join!', NOW() - INTERVAL '10 hours', TRUE),
(1,'Test', 'Reminder: be respectful in chat.', NOW() - INTERVAL '5 hours', TRUE);